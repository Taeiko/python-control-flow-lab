...
def weather_advice():
    ...
    weather = ('cold' and 'raining' or 'cold' not 'raining' or 'raining' not 'cold' or not 'cold' and not 'raining' )
    if  weather ==  'cold' and 'raining':
        print('Wear a waterproof coat.')
    elif weather == 'cold' not 'raining':
        print('Wear a warm coat.')
    elif weather == not 'cold' and 'raining':
